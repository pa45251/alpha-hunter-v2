...
|---:|---|---|---|---|---|---|
| 1 | 2606.TW | 裕民 | RESEARCH_FIRST | INSUFFICIENT | DRY_BULK_FREIGHT | The causal driver is not validated active; price strength cannot substitute for causality. |
...
- `DRIVER_NOT_ACTIVE_RESEARCH_VALIDATED`: 43
- `EDGE_PROVENANCE_NOT_SOURCE_BACKED`: 31
...
| 標的D | REVIEW_RESEARCH | SYSTEM_THESIS_COVERAGE_INCOMPLETE | SYSTEM_TICKER_EXPOSURE |
